...
<div class="container">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control border-dark text-dark <?= ($validation->hasError('lokasi')) ? 'is-invalid' : '' ?>" id="lokasi" name="lokasi" placeholder="GP 2000 [ contoh ]">
          <div id="validationServer03Feedback" class="invalid-feedback">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control border-dark text-dark <?= ($validation->hasError('slug')) ? 'is-invalid' : '' ?>" id="slug" name="slug" placeholder="246ABC123 [ contoh ]">
          <div id="validationServer03Feedback" class="invalid-feedback">
   ...
   <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control border-dark text-dark <?= ($validation->hasError('jenis_pekerjaan')) ? 'is-invalid' : '' ?>" id="jenis_pekerjaan" name="jenis_pekerjaan" placeholder="Radio HT GS Dept, Kerusakan mati, Perbaikan ganti Sparepart.... [ contoh ]">
          <div id="validationServer03Feedback" class="invalid-feedback">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control border-dark text-dark <?= ($validation->hasError('status')) ? 'is-invalid' : '' ?>" id="status" name="status" placeholder="Rfu / Pending [ contoh ]">
          <div id="validationServer03Feedback" class="invalid-feedback">
